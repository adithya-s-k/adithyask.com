...
import { GlobeIcon, MailIcon, PhoneIcon, ArrowRight, FileDown } from "lucide-react";
import { Button } from "@/components/ui/button";
import { RESUME_DATA } from "@/data/resume-data";
import { ProjectCard } from "@/components/project-card";
import { OpenSourceCard, OpenSourceSection } from "@/components/opensource-card";
      ...
      {visible && (
        ...
        >
          <div className="relative">
            ...
            <div className="text-4xl sm:text-6xl lg:text-9xl font-bold relative text-center flex flex-wrap justify-center gap-x-4">
              {nameWords.map((word, index) => (
                ...
                >
                  <HyperText 
                    className="bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 text-4xl sm:text-6xl lg:text-9xl font-bold"
                  >
                    {word}
                  </HyperText>
                </motion.div>
      ...
      try {
        ...
        for (const repoUrl of RESUME_DATA.open_source) {
          try {
            ...
            if (!response.ok) {
              console.error(`Failed to fetch repo data for ${repoUrl}: ${response.status}`);
              continue;
            }
          ...
          >
            ...
            >
              ...
              {!loading && repoData.length > 0 && (
                <FeaturedRepos repositories={repoData} title="Featured Open Source Work" />
              )}
              ...
              <Section id="blog" className="scroll-mt-16">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Recent articles and insights</p>
                  </div>
              ...
              <Section id="projects" className="print-force-new-page scroll-mt-16">
                ...
                <div className="-mx-3 grid grid-cols-1 gap-3 mt-4 print:grid-cols-3 print:gap-2 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Section id="education" className="scroll-mt-16">
                ...
                <div className="space-y-4 mt-4">
                  {RESUME_DATA.education.map((education) => (
                    <Card key={education.school} className="overflow-hidden border border-muted hover:shadow-sm transition-all p-4">
                      <CardHeader>
